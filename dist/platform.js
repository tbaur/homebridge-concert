...
class ConcertPlatform {
    ...
    pairWithCached(resolved) {
        ...
        for (const accessoryConfig of resolved) {
            ...
            this.log.info(`Adopting cached accessory "${(0, utils_1.forLog)(adopted.displayName)}" for `
                + `${(0, utils_1.accessoryIdentityKey)(accessoryConfig)} (registered by an earlier version)`);
