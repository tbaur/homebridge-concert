 ...
 */
export const POWER_SETTLE_MS = 1_500

/** How many settle+query attempts after a missing set ack. */
export const POWER_VERIFY_ATTEMPTS = 2
 ...
 */
export const VOLUME_READY_TIMEOUT_MS = 60_000
